...
///////////////////////////////  Fenetre d'acceuil  /////////////////////////////////////
		...
		//Boutton Miser	
				...
				this.BtnMiser = new Boutton("Miser",0,partie);
				ButtonPanel.add(BtnMiser);
				BtnMiser.act(partie.getTourDe());
				
				BtnMiser.addChangeListener(new ChangeListener() {
				...
				System.out.println("Bouton Miser créé");
		...
		//Boutton Spinner
				...
				System.out.println("spiner créé");

				
		//Boutton Suivre		
				
				this.btnSuivre = new Boutton("Suivre",0,partie);
				ButtonPanel.add(btnSuivre);
				
				btnSuivre.addChangeListener(new ChangeListener() {
					public void stateChanged(ChangeEvent e) {
				...
				System.out.println("Bouton Suivre créé");

				
		//Boutton Passer
				
				this.btnPasser = new Boutton("Passer",0,partie);
				ButtonPanel.add(btnPasser);
				
				btnPasser.addChangeListener(new ChangeListener() {
					public void stateChanged(ChangeEvent e) {
				...
				System.out.println("Bouton Passer créé");

				
		//Boutton Parole		
				
				this.btnParole = new Boutton("Parole",0,partie);
				
				ButtonPanel.add(btnParole);
				
				btnParole.addChangeListener(new ChangeListener() {
					public void stateChanged(ChangeEvent e) {
				...
				System.out.println("Bouton Parole créé");
	...
	
	{
		...
		try
		{
			reader = new ObjectInputStream(client.getInputStream()); // probleme ici
			System.out.println("Reader IHM opérationel");
